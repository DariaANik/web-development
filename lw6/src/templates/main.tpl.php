...
<html lang="ru">
  ...
  <body>
    ...
    <form method="POST" class="form">
      ...
      <input class="input_field <?=$args['name_error'] ?? '' ?>" name="name" type="text" required="required" title="Name" id="name" value="<?=$args['name'] ?? ''; ?>"/>
      <label for="email" class="label required">Ваш email</label>
      <input class="input_field <?=$args['email_error'] ?? '' ?>" name="email" type="email" required="required" title="Email" id="email" value="<?=$args['email'] ?? ''; ?>"/>
      <label for="country" class="label">Откуда вы?</label>
      <select class="select_field" name="country" title="Country" id="country">
        <option value="Россия" <?php if(($args['country'] === 'Россия') || ($args['country'] === null)){ echo 'selected="selected"'; }?>>Россия</option>
        <option value="Китай" <?php if($args['country'] == 'Китай'){ echo 'selected="selected"'; }?>>Китай</option>
        <option value="США" <?php if($args['country'] == 'США')  {echo 'selected="selected"'; }?>>США</option>
        <option value="Великобритания" <?php if($args['country'] == 'Великобритания') {echo 'selected="selected"';}?>>Великобритания</option>
        <option value="Германия" <?php if($args['country'] == 'Германия'){ echo 'selected="selected"'; }?>>Германия</option>
      </select>
